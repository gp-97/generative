...
fn test_line_x() {
    ...
    let mut line = shape2d::Line::new(vec![(100.0, 213.0), (100.0, 342.0)], (180_u8, 56_u8, 210_u8, 255_u8), 1);
...
fn test_line_y() {
    let mut canvas = Canvas::new(512, 512);
    let mut line = shape2d::Line::new(vec![(100.0, 213.0), (200.0, 213.0)], (180_u8, 56_u8, 210_u8, 255_u8), 1);
    line.draw(&mut canvas);
...
fn test_line_xy() {
    ...
    let mut line = shape2d::Line::new(vec![(100.0, 255.0), (200.0, 511.0)], (180_u8, 56_u8, 210_u8, 255_u8), 1);
    line.draw(&mut canvas);
...
fn test_rectangle() {
    let mut canvas = Canvas::new(512, 512);
    canvas.fill((0, 0, 0, 255_u8));
    let mut rect = shape2d::Rectangle::new([(32.0, 32.0), (480.0, 480.0)], (140, 30, 255, 255), 2);
...
fn test_square() {
    let mut canvas = Canvas::new(512, 512);
    canvas.fill((0, 0, 0, 255_u8));
    let mut sqr = shape2d::Square::new((50.0, 128.0), 256.0, (140, 30, 255, 255), 2);
    sqr.draw(&mut canvas);
...
fn test_quad() {
    ...
    let mut quad = shape2d::Quad::new(p, (182, 56, 10, 255), 2);
...
fn test_circle() {
    let mut canvas = Canvas::new(512, 512);
    canvas.fill((0, 0, 0, 255));
    let mut circle = shape2d::Circle::new((256.0, 256.0), 180.0, (255, 144, 31, 128), 2);
